      ...
      evidence: [
        ...
        },
        {
          ...
          details: {
            type: 'Forensic',
            details:
              'Found on a glass matching the victim’s favorite lipstick.',
          },
        },
        {
          name: 'Necklace',
      ...
      evidence: [
        ...
        },
        {
          ...
          details: {
            type: 'Prop',
            details:
              'Found with traces of the victim’s blood and fingerprints.',
          },
        },
        {
          name: 'Anonymous Note',
